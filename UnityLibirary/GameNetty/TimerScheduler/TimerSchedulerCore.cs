...
namespace GameNetty
{
    ...
    public class TimerSchedulerCore
    {
        ...
        /// <returns>等待是否成功。</returns>
        public async FTask<bool> WaitAsync(long time, GameCancellationToken cancellationToken = null)
        {
        ...
        /// <param name="cancellationToken">可选的取消令牌。</param>
        /// <returns>等待是否成功。</returns>
        public async FTask<bool> WaitTillAsync(long tillTime, GameCancellationToken cancellationToken = null)
        {
            if (_now() > tillTime)
            {
                return true;
