...
namespace GameNetty
{
    ...
    public partial class GameTask
    {
        ...
        /// 获取一个已完成的异步任务实例。
        /// </summary>
        public static GameTaskCompleted CompletedTask => new();
        ...
        public static GameTask Run(Func<GameTask> factory)
        {
            return factory();
        }
        ...
        /// <param name="factory">用于创建异步任务的工厂方法。</param>
        /// <returns>创建并运行的异步任务。</returns>
        public static GameTask<T> Run<T>(Func<GameTask<T>> factory)
        {
            return factory();
        }
        ...
        public static GameTask<T> FromResult<T>(T value)
        {
            var sAwaiter = GameTask<T>.Create();
